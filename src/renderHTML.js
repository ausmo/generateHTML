...
allEmployeesArray.push(allEmployees
    ...
    allEmployeesArray.push(allEmployees
        ...
        module.exports = allEmployees => {
            ...
            <body>
            <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#FFA500" fill-opacity="1" d="M0,160L48,170.7C96,181,192,203,288,208C384,213,480,203,576,170.7C672,139,768,85,864,58.7C960,32,1056,32,1152,69.3C1248,107,1344,181,1392,218.7L1440,256L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
                     <header class="blog-header col-12 pb-4">
                         <div class="col-12 text-center">
                             <H1 class="blog-header-logo fw-bold" >Austin's Team Generator</h1>
                             </div>
                         </header>
